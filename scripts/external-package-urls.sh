...
files1=(
    ...
    "sms-tool|https://downloads.openwrt.org/releases/$(echo "$BRANCH" | cut -d'.' -f1-2)/packages/$ARCH_3/packages"
    ...
    #"luci-app-internet-detector|https://dl.openwrt.ai/releases/24.10/packages/$ARCH_3/kiddin9"
    #"internet-detector-mod-modem-restart|https://dl.openwrt.ai/releases/24.10/packages/$ARCH_3/kiddin9"
    #"luci-app-netspeedtest|https://dl.openwrt.ai/releases/24.10/packages/$ARCH_3/kiddin9"
    #"luci-app-temp-status|https://dl.openwrt.ai/releases/24.10/packages/$ARCH_3/kiddin9"
    #"luci-app-cpu-status-mini|https://dl.openwrt.ai/releases/24.10/packages/$ARCH_3/kiddin9"
    #"luci-app-log-viewer|https://dl.openwrt.ai/releases/24.10/packages/$ARCH_3/kiddin9"
