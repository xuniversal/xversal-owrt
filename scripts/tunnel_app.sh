...
# passwall2
passwall2_api="https://api.github.com/repos/xiaorouji/openwrt-passwall2/releases"
passwall2_file="passwall2_packages_ipk_$ARCH_3.zip"
passwall2_file_down="$(curl -s ${passwall2_api} | grep "browser_download_url" | grep -oE "https.*${passwall2_file}.*.ipk" | head -n 1)"
passwall2_ipk="https://github.com/xiaorouji/openwrt-passwall2/releases/download/25.1.8-1/luci-23.05_luci-app-passwall2_25.1.8_all.ipk"
